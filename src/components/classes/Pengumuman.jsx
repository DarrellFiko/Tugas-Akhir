...
export default function Pengumuman({ data, commentInputs, setCommentInputs, sendComment, itemsPerPage = 10 }) {
  ...
  }, [paginatedData, data]); // setiap data atau paginatedData berubah
              ...
              <Box sx={{ border: "solid 1px", borderRadius: 2, mt: 2, p: 2 }}>
                ...
                {item.comments.length > 0 ? (
                  <Box
                    ...
                    sx={{ maxHeight: "300px", overflowY: "auto", display: "flex", flexDirection: "column", px: 2 }}
                  >
                    {item.comments.map((comment, index) => (
                      <Box key={index} sx={{ display: "flex", gap: 1, mt: 1, alignItems: "flex-start" }}>
